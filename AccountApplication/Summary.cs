...
namespace AccountApplication
{
    public partial class Summary : Form
    {
        ...
        private void Summary_Load(object sender, EventArgs e)
        {
            ...
            comboBoxCompanyList.SelectedIndex =1 ;
        ...
        private void buttonGo_Click(object sender, EventArgs e)
        {
            if (!comboBoxCompanyList.SelectedItem.ToString().Equals(""))
            {
                this.Hide();
                string companyName = "";
                if (comboBoxCompanyList.SelectedText.Equals(""))
                    companyName = (((System.Data.DataRowView)(comboBoxCompanyList.SelectedItem)).Row).ItemArray[0].ToString();
                else
                    companyName = comboBoxCompanyList.SelectedText;
                AccountDetails accountDetail = new AccountDetails(companyName);
                accountDetail.Show();
            }
        }
        ...
        private void printDocumentAccounts_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                //Set the left margin
                ...
                if (bFirstPage)
                {
                    foreach (DataGridViewColumn GridCol in dataGridViewSummary.Columns)
                    {
                ...
                while (iRow <= dataGridViewSummary.Rows.Count - 1)
                {
                    DataGridViewRow GridRow = dataGridViewSummary.Rows[iRow];
                    //Set the cell height
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("PSV Fruits Ltd",
                                new Font(dataGridViewSummary.Font, FontStyle.Bold),
                            ...
                            e.Graphics.DrawString(strDate,
                                new Font(dataGridViewSummary.Font, FontStyle.Bold), Brushes.Black,
                                e.MarginBounds.Left +
                                (e.MarginBounds.Width - e.Graphics.MeasureString(strDate,
                                new Font(dataGridViewSummary.Font, FontStyle.Bold),
                                e.MarginBounds.Width).Width),
                                e.MarginBounds.Top - e.Graphics.MeasureString("PSV Fruits Ltd",
                                new Font(new Font(dataGridViewSummary.Font, FontStyle.Bold),
        ...
        private void printDocumentAccounts_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                iTotalWidth = 0;
                foreach (DataGridViewColumn dgvGridCol in dataGridViewSummary.Columns)
                {
